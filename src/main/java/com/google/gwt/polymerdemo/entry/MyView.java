...
import com.google.gwt.polymerdemo.polymerstubs.PaperToggleButton;
...
public class MyView extends Composite {
  ...
  public MyView() {
    ...
    starButton.addEventListener("click", new EventListener() {
      @Override 
      public void handleEvent(Event event) {
        Window.alert("You pressed the star! " + checkbox.getChecked());
      }
    });
      ...
      checkbox.addEventListener("change", new EventListener() {
          @Override
          public void handleEvent(Event event) {
              Window.alert("Hey what are you doing !!!");
          }
      });
